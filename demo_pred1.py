...
def tracking_skeleton_visualize(imgs, skeleton_imgs=None, mot_res=None):
    from module.utils.visualize import vis_mot_res1, vis_skeleton_res
    from module.utils.imgs_convert import imgs2video
    
    imgs_res = imgs.copy()
    # tracking result
    if mot_res is not None:
        imgs_res = vis_mot_res1(imgs_res, mot_res)
    ...
    # save to the video
    save_path = "demo_output/tracking_res_filter.avi"
...
if __name__ == "__main__":
    ...
    # # save res
    # with open("mot_res.json", "w") as f:
    #     json.dump(new_mot_res, f, indent=2)
    ...
    tracking_skeleton_visualize(imgs, mot_res=new_mot_res, skeleton_imgs=skeleton_imgs)